...
import clarification9 from "../../../data/fr/Clarification9.md";
import sar from "../../../data/fr/SAR.md";
import uniforms from "../../../data/fr/AthleteUniformRegulations.md";
import sandRegulations from "../../../data/fr/SandRegulations.md";
import glossary from "../../../data/fr/Glossary.md";
import equipment from "../../../data/fr/EquipmentAccessories.md";
