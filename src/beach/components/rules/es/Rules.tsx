...
import clarification9 from "../../../data/es/Clarification9.md";
import sar from "../../../data/es/SAR.md";
import uniforms from "../../../data/es/AthleteUniformRegulations.md";
import sandRegulations from "../../../data/es/SandRegulations.md";
import glossary from "../../../data/es/Glossary.md";
